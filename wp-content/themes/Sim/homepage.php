...
get_header(); ?>
		<?php function get_post_vars($post){
			global $title, $first_column, $second_column, $third_column, $layout_style, $arrow_between, $language;
		...
		<?php switch ($language) {
			case 'en-US':
				$home_page = 'english-homepage';
				$services_page = 'services';
				$about_page = 'about';
				$why_page = 'why-sim';
				$contact_page = 'contact';
				$estimate_page = 'price-estimate';
				$join_page = 'join-us';
				break;

			default:
				$home_page = 'home';
				$services_page = 'servicos';
				$about_page = 'sobre';
				$why_page = 'por-que-a-sim';
				$contact_page = 'contato';
				$estimate_page = 'orcamento';
				$join_page = 'trabalhe-conosco';
				break;
		};?>
		<section id="home" class="content-area">
		<?php $my_query = new WP_Query("name=$home_page&post_type=areas&showposts=-1"); ?>
      ...
      <?php $my_query = new WP_Query("name=$services_page&post_type=areas&showposts=-1"); ?>
		<?php if($my_query->have_posts()) : ?><?php while($my_query->have_posts()) : $my_query->the_post(); ?>
			<?php get_post_vars($post);?>
			<?php if($title): ?>
				<h1 class="big-call-out">
      ...
      <?php $my_query = new WP_Query("name=$about_page&post_type=areas&showposts=-1"); ?>
		<?php if($my_query->have_posts()) : ?><?php while($my_query->have_posts()) : $my_query->the_post(); ?>
			<?php get_post_vars($post);?>
			<?php if($title): ?>
				<h1 class="big-call-out">
      ...
      <?php $my_query = new WP_Query("name=$why_page&post_type=areas&showposts=-1"); ?>
		<?php if($my_query->have_posts()) : ?><?php while($my_query->have_posts()) : $my_query->the_post(); ?>
			<?php get_post_vars($post);?>
			<?php if($title): ?>
				<h1 class="big-call-out">
      ...
      <section id="contact" class="content-area">
         ...
         <?php $my_query = new WP_Query("name=$contact_page&post_type=areas&showposts=-1"); ?>
			<?php if($my_query->have_posts()) : ?><?php while($my_query->have_posts()) : $my_query->the_post(); ?>
				<?php get_post_vars($post);?>
				<?php if($title): ?>
					<h1 class="big-call-out">
         ...
         <?php $my_query = new WP_Query("name=$estimate_page&post_type=areas&showposts=-1"); ?>
			<?php if($my_query->have_posts()) : ?><?php while($my_query->have_posts()) : $my_query->the_post(); ?>
				<?php get_post_vars($post);?>
				<?php if($title): ?>
					<h1 class="big-call-out">
         ...
         <?php $my_query = new WP_Query("name=$join_page&post_type=areas&showposts=-1"); ?>
			<?php if($my_query->have_posts()) : ?><?php while($my_query->have_posts()) : $my_query->the_post(); ?>
				<?php get_post_vars($post);?>
				<?php if($title): ?>
					<h1 class="big-call-out">
